...
prompt = ChatPromptTemplate.from_messages([
    ("system", '''Analyze the sentence and output exactly in this format:  
[time, subject, object, verb]  
Replace missing elements with "none".  

Example:  
Input: "She eats apples"  
Output: [none, She, apples, eats]
Input: "Tomorrow, John will send the package"
Output: [Tomorrow, John, the package, will send]
Input: "The cat slept"
Output: [none, The cat, none, slept]'''),
